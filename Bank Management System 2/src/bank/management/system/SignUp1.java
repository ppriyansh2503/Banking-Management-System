...
public class SignUp1 extends JFrame implements ActionListener{
	...
	add(dateChooser); 
        ...
        r3.setBounds(300, 390, 80, 30);
        r3.setBackground(Color.WHITE);
        add(r3);
        
        r4 = new JRadioButton("Unmarried");
        r4.setFont(new Font("Raleway", Font.BOLD, 14));
        r4.setBounds(400, 390, 100, 30);
        r4.setBackground(Color.WHITE);
        add(r4);
        
        r5 = new JRadioButton("Others");
        r5.setFont(new Font("Raleway", Font.BOLD, 14));
        r5.setBounds(500, 390, 100, 30);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            if(t1.getText().equals("")){
                JOptionPane.showMessageDialog(null, "Fill all the required name");
            }else if(t2.getText().equals("")){
                JOptionPane.showMessageDialog(null, "Fill all the required father's name");
            }else if(t3.getText().equals("")){
                JOptionPane.showMessageDialog(null, "Fill all the required Email address");
            }else if(t4.getText().equals("")){
                JOptionPane.showMessageDialog(null, "Fill all the required adress");
